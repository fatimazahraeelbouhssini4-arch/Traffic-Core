...
Le projet propose une **interface graphique intégrée** avec un menu affiché à l’écran permettant de contrôler la simulation en temps réel.

## Membres de l'équipe

- **Ouarda Ait El Fakih** – [@ouarda-aitelafkih](https://github.com/ouarda-aitelfakih)
...
- Circulation dynamique de plusieurs véhicules en 3D
- Menu interactif intégré à l’écran avec informations en temps réel :
  - Nombre de véhicules
  - Temps écoulé
